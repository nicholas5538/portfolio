...
const ProjectCard = ({
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        <li className="grid grid-rows-1 rounded-lg py-4 px-5 shadow-project md:grid-cols-12 md:grid-rows-5 md:items-center md:justify-items-center md:rounded-none md:shadow-none">
          <h3
